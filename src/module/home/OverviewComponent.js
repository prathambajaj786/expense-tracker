...
const AddTransactionView=(props)=>{
    ...
    const addTransaction=()=>{
        ...
        props.toggleAddTxn();               //error (not closing window on click)
    }
    ...
    return (
        <Container>
            <BalanceBox>
                ...
                {/* Understand the next line in depth */}
                <AddTransaction onClick={()=>toggleAddTxn(!isAddTxnVisible)}> {isAddTxnVisible ? "Cancel " : "Add"}</AddTransaction>  
            </BalanceBox>
            {/* Major Doubt In Next Line */}
            {
            isAddTxnVisible && 
            <AddTransactionView toggleAddTxn ={toggleAddTxn }
